...
public class TBrowser implements Serializable {
    ...
    public enum Column {
        ...
        remoteUrl("remote_url", "remoteUrl", "VARCHAR", false),
        browserName("browser_name", "browserName", "VARCHAR", false),
        browserVersion("browser_version", "browserVersion", "VARCHAR", false),
