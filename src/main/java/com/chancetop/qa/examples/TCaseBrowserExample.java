...
public class TCaseBrowserExample {
    ...
    public TCaseBrowserExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public TCaseBrowserExample orderBy(String ... orderByClauses) {
    ...
    public static Criteria newAndCreateCriteria() {
        TCaseBrowserExample example = new TCaseBrowserExample();
        return example.createCriteria();
    }

    public TCaseBrowserExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public TCaseBrowserExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private TCaseBrowserExample example;

        protected Criteria(TCaseBrowserExample example) {
            super();
            this.example = example;
        }

        public TCaseBrowserExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.chancetop.qa.examples.TCaseBrowserExample example);
    }
}