...
public class TEnvironmentExample {
    ...
    public TEnvironmentExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public TEnvironmentExample orderBy(String ... orderByClauses) {
    ...
    public static Criteria newAndCreateCriteria() {
        TEnvironmentExample example = new TEnvironmentExample();
        return example.createCriteria();
    }

    public TEnvironmentExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public TEnvironmentExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private TEnvironmentExample example;

        protected Criteria(TEnvironmentExample example) {
            super();
            this.example = example;
        }

        public TEnvironmentExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.chancetop.qa.examples.TEnvironmentExample example);
    }
}